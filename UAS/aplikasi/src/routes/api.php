...
// kendaraans
Route::prefix('kendaraans')->middleware('apikey')->group(function () {
    Route::get('/', [Kendaraan::class, 'index']);     // GET /api/products
    Route::get('{id}', [Kendaraan::class, 'show']);   // GET /api/products/{id}
});
